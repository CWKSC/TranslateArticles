...
!function(i){i.fn.simpleJekyllSearch=function(e){var o=i.extend({jsonFile:"/TranslateArticles/search.json",jsonFormat:"title,tags,categories,url,date",template:'<li><article><a href="{url}"><span class="entry-category">{categories}</span> {title} <span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:"<p>Oh no! We didn't find anything :(</p>"},e),s=o.jsonFormat.split(",");console.log("simpleJekyllSearch"),console.log(s);var a=[],n=this,r=i(o.searchResults);function c(){r.children().remove()}o.jsonFile.length&&r.length&&i.ajax({type:"GET",url:o.jsonFile,dataType:"json",success:function(e,l,t){a=e,n.keyup(function(e){var l;i(this).val().length?(console.log("Test"),l=function(t){console.log("performSearch");var n=[];return i.each(a,function(e,l){for(e=0;e<s.length;e++)void 0!==l[s[e]]&&-1!==l[s[e]].toLowerCase().indexOf(t.toLowerCase())&&(n.push(l),e=s.length)}),console.log(n),n}(i(this).val()),c(),r.append(i(o.searchResultsTitle)),l.length?i.each(l,function(e,l){if(e<o.limit){for(var t=o.template,e=0;e<s.length;e++){var n=new RegExp("{"+s[e]+"}","g");t=t.replace(n,l[s[e]])}r.append(i(t))}}):r.append(o.noResults)):(console.log("Test clearSearchResults"),c())})},error:function(e,l,t){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(l),console.log(t)}})}}(Zepto);
